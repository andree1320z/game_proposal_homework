...
public class Memory {
    ...
    private static final String SHARED_PREFERENCES_NAME = "pe.upao.andree";
    ...
    public static void save(int theme, int difficulty, int stars) {
        ...
        if (stars > highStars) {
            SharedPreferences sharedPreferences = pe.upao.andree.common.Shared.context.getSharedPreferences(SHARED_PREFERENCES_NAME,
